...
export const Intro: React.FC<IntroProps> = ({ onComplete }) => {
    ...
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center pointer-events-none`}>
      ...
      <div className={`relative z-30 flex flex-col items-center justify-center transition-opacity duration-300 ${isExiting ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div className="relative mb-8 text-center">
           <h1 className="text-4xl md:text-8xl font-dela font-black text-white tracking-[0.05em] relative inline-block uppercase">
  Aizen_Verse
  <span
  ...
  >
    Aizen_Verse
           ...
           <div className="absolute -bottom-6 right-0 text-xs font-mono text-white tracking-[0.5em] uppercase hidden md:block">System.Start</div>
        </div>
        ...
        <div className="absolute bottom-10 left-10 text-white/30 font-space text-4xl hidden md:block select-none">
           アニメ
        </div>
        <div className="absolute top-10 right-10 text-white/30 font-space text-4xl hidden md:block select-none">
           起動
        </div>

        <div className="mt-6 font-space text-xs text-gray-500 flex flex-col items-center gap-2">
